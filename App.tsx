...
const GlowCard: React.FC<{
  ...
  return (
    ...
    >
      <div
        className={`absolute inset-0 rounded-3xl md:rounded-[2rem] pointer-events-none transition-opacity duration-1000 overflow-hidden ${
  ...
  <div className="w-full p-6 md:p-8 rounded-2xl md:rounded-[2rem] my-6 md:my-8 flex flex-col xl:flex-row items-center justify-between gap-6 md:gap-8 bg-slate-50 border-2 md:border-4 border-slate-200 relative overflow-hidden">
    ...
    <div className="relative z-10 flex flex-col items-center gap-2 md:gap-4 group flex-1">
      ...
      <div className="text-center">
        <div className="font-black text-base md:text-xl uppercase tracking-widest mb-1 md:mb-2 text-green-700">
          INPUT
        </div>
        <div className="text-xs md:text-sm font-bold text-slate-700 bg-white px-3 py-1 rounded-full shadow-sm border border-slate-200">
          Bàn phím
        </div>
        <div className="mt-2 font-mono font-black text-sm md:text-xl text-green-800 bg-green-100 px-3 py-1 md:px-6 md:py-2 rounded-lg md:rounded-xl border md:border-2 border-green-200">
          input()
        </div>
      </div>
    </div>
    ...
    <div className="relative z-10 flex flex-col items-center gap-2 md:gap-4 group flex-1">
      <div className="w-20 h-20 md:w-32 md:h-32 rounded-full flex items-center justify-center shadow-lg transition-transform group-hover:rotate-12 bg-gradient-to-br from-indigo-500 to-indigo-700 text-white relative">
        <Cpu
          className="w-10 h-10 md:w-16 md:h-16 animate-pulse-slow"
          strokeWidth={1.5}
        />
      ...
      <div className="text-center">
        <div className="font-black text-base md:text-xl uppercase tracking-widest mb-1 md:mb-2 text-indigo-700">
          PROCESS
        </div>
        <div className="text-xs md:text-sm font-bold text-slate-700 bg-white px-3 py-1 rounded-full shadow-sm border border-slate-200">
          CPU Xử lý
        </div>
        <div className="mt-2 font-mono font-black text-sm md:text-xl text-indigo-800 bg-indigo-100 px-3 py-1 md:px-6 md:py-2 rounded-lg md:rounded-xl border md:border-2 border-indigo-200">
          Chương trình
        </div>
      </div>
    </div>
    ...
    <div className="relative z-10 flex flex-col items-center gap-2 md:gap-4 group flex-1">
      ...
      <div className="text-center">
        <div className="font-black text-base md:text-xl uppercase tracking-widest mb-1 md:mb-2 text-blue-700">
          OUTPUT
        </div>
        <div className="text-xs md:text-sm font-bold text-slate-700 bg-white px-3 py-1 rounded-full shadow-sm border border-slate-200">
          Màn hình
        </div>
        <div className="mt-2 font-mono font-black text-sm md:text-xl text-blue-800 bg-blue-100 px-3 py-1 md:px-6 md:py-2 rounded-lg md:rounded-xl border md:border-2 border-blue-200">
          print()
        </div>
      </div>
    </div>
  ...
  <div className="w-full p-4 md:p-8 rounded-2xl md:rounded-[2rem] border-2 flex flex-col gap-4 md:gap-8 my-6 md:my-8 bg-slate-50 border-slate-300 shadow-inner">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8 text-center">
      <div className="p-4 md:p-6 rounded-xl md:rounded-2xl relative bg-white border-2 border-slate-300 shadow-md">
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-purple-700 text-white text-xs md:text-sm font-black rounded-full uppercase shadow-md">
          Bước 1
        </div>
        <div className="font-mono text-xs md:text-sm mb-1 md:mb-2 text-slate-500 font-bold">
          Code chạy:
        </div>
        ...
        <div className="text-xs md:text-base font-bold text-black leading-relaxed">
          Máy tính dừng lại chờ đợi.
        </div>
      </div>

      <div className="p-4 md:p-6 rounded-xl md:rounded-2xl relative bg-white border-2 border-slate-300 shadow-md">
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-blue-700 text-white text-xs md:text-sm font-black rounded-full uppercase shadow-md">
          Bước 2
        </div>
        <div className="font-mono text-xs md:text-sm mb-1 md:mb-2 text-slate-500 font-bold">
          Người dùng:
        ...
        <div className="text-xs md:text-base font-bold text-black leading-relaxed">
          Nhập "An" và nhấn Enter.
        </div>
      </div>

      <div className="p-4 md:p-6 rounded-xl md:rounded-2xl relative bg-white border-2 border-slate-300 shadow-md">
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-green-700 text-white text-xs md:text-sm font-black rounded-full uppercase shadow-md">
          Bước 3
        </div>
        <div className="font-mono text-xs md:text-sm mb-1 md:mb-2 text-slate-500 font-bold">
          Bộ nhớ:
...
const DataTypeVisuals = () => (
  <div className="grid grid-cols-1 gap-6 md:gap-10 mb-8 md:mb-16">
    {[
      ...
      <div
        key={t.label}
        className={`relative p-6 md:p-10 bg-white border-l-[6px] border-${t.color}-500 rounded-3xl shadow-md hover:shadow-2xl transition-all duration-300 group`}
      >
        {/* Header */}
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-4 md:gap-6">
            <div
              className={`p-4 md:p-5 rounded-2xl bg-${t.color}-100 text-${t.color}-600 group-hover:scale-110 transition-transform`}
            >
              {t.icon}
            </div>
            <div>
              <h4
                className={`text-3xl md:text-5xl font-black text-${t.color}-900`}
              >
                {t.label}
              </h4>
              <span className="text-sm md:text-xl font-bold uppercase tracking-wider text-slate-500">
                {t.name}
              </span>
            </div>
          </div>
          <div
            className={`px-4 py-2 rounded-full text-sm md:text-lg font-bold bg-${t.color}-50 text-${t.color}-600 border-2 border-${t.color}-200`}
          >
            Python Type
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              {t.valid.map((v, i) => (
                <li
                  key={i}
                  className="px-4 py-3 bg-slate-50 rounded-xl border border-slate-200 text-slate-800 font-bold shadow-sm"
                >
                  {v}
                </li>
              ))}
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              {t.invalid.map((v, i) => (
                <li
                  key={i}
                  className="px-4 py-3 bg-red-50 rounded-xl border border-red-100 text-red-800 opacity-90"
                >
                  {v}
                </li>
              ))}
...
const VideoEmbed = ({ url }: { url: string }) => (
  <div className="relative max-w-4xl mx-auto my-12 group">
    ...
    <div className="relative bg-black rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/10">
      ...
      <div className="bg-slate-900 px-6 py-4 flex justify-between items-center border-t border-slate-800">
        <div className="flex items-center gap-3 text-slate-300 font-bold">
          ...
          <span className="text-sm md:text-base">
            Video Bài Giảng: Lệnh Vào Ra Đơn Giản
          </span>
        </div>
      </div>
    </div>
...
const quizzes = [
  {
    id: 1,
    question: "Lệnh input() dùng để làm gì?",
    options: ["Xuất dữ liệu", "Nhập dữ liệu", "Tính toán", "Dừng chương trình"],
    correct: 1,
    explanation: "input() dùng để nhận dữ liệu từ bàn phím.",
    difficulty: "Dễ",
  },
  {
    id: 2,
    ...
    correct: 1,
    explanation: "print() đưa dữ liệu ra màn hình.",
    difficulty: "Dễ",
  },
  {
    id: 3,
    question: "Hàm input() luôn trả về kiểu dữ liệu gì?",
    options: [
      "Số nguyên (int)",
      "Số thực (float)",
      "Xâu kí tự (str)",
    ...
    correct: 2,
    explanation: "Bất kể bạn nhập gì, input() luôn trả về chuỗi (string).",
    difficulty: "TB",
  },
  {
    id: 4,
    question: "Để chuyển xâu '123' thành số nguyên, ta dùng lệnh nào?",
    options: ["float('123')", "str(123)", "int('123')", "type('123')"],
    correct: 2,
    explanation: "int() chuyển đổi xâu thành số nguyên.",
    difficulty: "Dễ",
  },
  {
    id: 5,
    question: "Kết quả của lệnh type(10.5) là gì?",
    options: [
      "<class 'int'>",
      "<class 'str'>",
      "<class 'float'>",
    ...
    correct: 2,
    explanation: "10.5 là số thực (float).",
    difficulty: "Dễ",
  },
  {
    id: 6,
    question: "Lệnh nào sau đây sẽ BÁO LỖI?",
    options: ["int('15')", "float(10)", "int('10.5')", "str(100)"],
    correct: 2,
    explanation:
      "int() không thể chuyển trực tiếp xâu chứa dấu chấm động ('10.5') thành số nguyên.",
    difficulty: "Khó",
  },
  {
    id: 7,
    question: "Kết quả của print('A' + 'B') là gì?",
    options: ["AB", "A B", "Lỗi", "0"],
    correct: 0,
    explanation: "Toán tử + với xâu kí tự có tác dụng nối xâu.",
    difficulty: "TB",
  },
  {
    id: 8,
    question: "Để nhập một số thực từ bàn phím, ta nên viết:",
    options: [
      "x = input()",
      "x = int(input())",
      "x = float(input())",
    ...
    correct: 2,
    explanation: "Cần dùng float() bao bên ngoài input().",
    difficulty: "TB",
  },
  {
    id: 9,
    question: "Kiểu dữ liệu 'bool' có mấy giá trị?",
    options: ["1", "2", "3", "Vô số"],
    correct: 1,
    explanation: "Chỉ có True và False.",
    difficulty: "Dễ",
  },
  {
    id: 10,
    question: "Kết quả của 10 > 5 là?",
    options: ["True", "False", "10", "5"],
    correct: 0,
    explanation: "Phép so sánh trả về kiểu bool (True).",
    difficulty: "Dễ",
  },
];
...
const exercises = [
  {
    id: 1,
    title: "Lời chào",
    desc: "Nhập tên và in ra: 'Xin chào [Tên]!'",
    hint: "Dùng input() và print().",
  },
  {
    id: 2,
    title: "Phép cộng",
    desc: "Nhập vào 2 số nguyên a và b. In ra tổng.",
    hint: "Dùng int(input()).",
  },
  {
    id: 3,
    title: "Tính tuổi",
    desc: "Nhập năm sinh. In ra tuổi hiện tại.",
    hint: "Tuổi = 2024 - Năm sinh.",
  },
  {
    id: 4,
    title: "Hình chữ nhật",
    desc: "Nhập chiều dài, rộng (số thực). Tính chu vi, diện tích.",
    hint: "Dùng float(input()).",
  },
  {
    id: 5,
    title: "Đổi tiền",
    desc: "Nhập số tiền USD. Đổi sang VND (1 USD = 24k).",
    hint: "Tiền Việt = Tiền Đô * 24000.",
  },
];
...
const App: React.FC = () => {
  ...
  const [typeTestOutput, setTypeTestOutput] = useState<{
    text: string;
    type: string;
  } | null>(null);
  ...
  const bodyText =
    "text-sm md:text-base lg:text-lg leading-relaxed text-slate-900 font-bold";
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-indigo-500 selection:text-white pb-32 md:pb-80 bg-[#A9A9A9] text-black overflow-x-hidden">
      ...
      <main className="max-w-5xl mx-auto pt-8 md:pt-20 px-4 md:px-8 space-y-12 md:space-y-32">
        ...
        <VideoEmbed url="/Lệnh_Vào_Ra_Đơn_Giản.mp4" />
            ...
            <div className={bodyText}>
              ...
              <div className="bg-yellow-50 p-6 md:p-10 rounded-3xl border-2 border-yellow-200 shadow-lg mb-8 md:mb-12">
                <p className="text-sm md:text-xl text-yellow-900 font-medium leading-relaxed">
                  Hãy tưởng tượng máy tính giống như một người bạn robot 🤖. Để
                  robot giúp chúng ta làm bài tập, chúng ta cần làm 3 bước:
                  <br className="mb-4" />
                  1.{" "}
              ...
              <div className="flex flex-col gap-6 md:gap-8 mt-8 md:mt-12">
                <div className="p-6 md:p-10 rounded-2xl md:rounded-[2.5rem] bg-green-50 border-l-[8px] md:border-l-[12px] border-green-500 shadow-md transform hover:scale-[1.02] transition-transform">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <strong className="text-green-800 text-xl md:text-4xl font-black uppercase tracking-wider">
                      INPUT (Nhập)
                    </strong>
                  </div>
                  <p className="text-base md:text-2xl leading-relaxed text-green-900 font-bold opacity-80 pl-2">
                    ...
                    <br />
                    Trong Python, ta dùng lệnh{" "}
                    <code className="font-mono bg-green-200 text-green-800 px-3 py-1 rounded-lg border border-green-300 mx-1">
                      input()
                    </code>{" "}
                    để nhập dữ liệu.
                  </p>
                ...
                <div className="p-6 md:p-10 rounded-2xl md:rounded-[2.5rem] bg-indigo-50 border-l-[8px] md:border-l-[12px] border-indigo-500 shadow-md transform hover:scale-[1.02] transition-transform">
                  <div className="flex items-center gap-4 mb-4">
                    <span className="text-3xl md:text-5xl">🧠</span>
                    <strong className="text-indigo-800 text-xl md:text-4xl font-black uppercase tracking-wider">
                      PROCESS (Xử lý)
                    </strong>
                  </div>
                  <p className="text-base md:text-2xl leading-relaxed text-indigo-900 font-bold opacity-80 pl-2">
                    ...
                    <br />
                    Máy tính sẽ cộng trừ nhân chia, hoặc xử lý văn bản theo ý
                    chúng ta. Chúng ta không nhìn thấy quá trình này đâu!
                  </p>
                </div>
                ...
                <div className="p-6 md:p-10 rounded-2xl md:rounded-[2.5rem] bg-blue-50 border-l-[8px] md:border-l-[12px] border-blue-500 shadow-md transform hover:scale-[1.02] transition-transform">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <strong className="text-blue-800 text-xl md:text-4xl font-black uppercase tracking-wider">
                      OUTPUT (Xuất)
                    </strong>
                  </div>
                  <p className="text-base md:text-2xl leading-relaxed text-blue-900 font-bold opacity-80 pl-2">
                    ...
                    <br />
                    Máy tính sẽ hiện kết quả ra màn hình bằng lệnh{" "}
                    <code className="font-mono bg-blue-200 text-blue-800 px-3 py-1 rounded-lg border border-blue-300 mx-1">
                      print()
                    </code>
                    .
                  </p>
          ...
          <div className="flex flex-col gap-10 md:gap-20">
            <GlowCard>
              <h3 className="text-2xl md:text-5xl font-black mb-6 md:mb-10 text-green-900 flex items-center gap-4 md:gap-6">
                <Keyboard className="w-10 h-10 md:w-20 md:h-20" /> Lệnh Nhập:
                input()
              </h3>
              ...
              <div className="bg-amber-50 border-l-[6px] md:border-l-[10px] border-amber-500 p-4 md:p-8 rounded-r-xl md:rounded-r-[2rem] my-6 shadow-lg">
                <div className="flex items-center gap-2 md:gap-4 mb-2">
                  ...
                  <span className="font-black text-base md:text-xl text-amber-800 uppercase tracking-tighter">
                    CẢNH BÁO!
                  </span>
                </div>
                <p className="text-sm md:text-lg text-amber-900 font-black leading-tight">
                  Mọi thứ nhập vào luôn là{" "}
              ...
              <div className="bg-slate-800 rounded-3xl p-6 md:p-10 shadow-2xl border border-slate-700 relative overflow-hidden group my-8">
                ...
                <div className="absolute top-0 left-0 w-full h-10 bg-slate-900/50 flex items-center px-4 gap-2 border-b border-white/10">
                  ...
                  <span className="ml-2 text-xs text-slate-400 font-mono font-bold">
                    python_interactive_demo.py
                  </span>
                </div>
                ...
                <div className="mt-8 space-y-6 md:space-y-8">
                  ...
                  <div className="font-mono text-sm md:text-lg text-slate-300 bg-black/30 p-4 md:p-6 rounded-xl border border-white/5 shadow-inner">
                    <div className="text-slate-500 italic mb-2">
                      # Chương trình chào hỏi đơn giản
                    </div>
                    <div className="leading-relaxed">
                      ...
                      <div>
                        ...
                        <span className="text-green-400">"Xin chào, "</span> +{" "}
                        <span className="text-purple-400">name</span> +{" "}
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="relative">
                      <div className="absolute left-4 top-1/2 -translate-y-1/2 text-green-500 font-mono font-bold text-lg">
                        {">"}
                      </div>
                      <input
                        type="text"
                  ...
                  {demoOutput && (
                    <div className="animate-in fade-in slide-in-from-top-4 duration-500">
                      <div className="text-xs uppercase tracking-widest text-slate-400 mb-2 font-bold pl-2">
                        KẾT QUẢ (OUTPUT):
                      </div>
              ...
              <div className="bg-slate-900 rounded-3xl p-6 md:p-10 shadow-2xl border-4 border-slate-700 relative overflow-hidden group my-8">
                ...
                <div className="absolute top-0 left-0 w-full h-10 bg-slate-800 flex items-center px-4 gap-2 border-b border-white/5">
                  ...
                  <div className="w-3 h-3 rounded-full bg-slate-600"></div>
                  <span className="ml-2 text-xs text-slate-500 font-mono font-bold">
                    test_type.py
                  </span>
                </div>
                ...
                <div className="mt-8 space-y-6 md:space-y-8">
                  <div className="flex items-center gap-3 text-white">
                    ...
                    <div className="flex flex-col">
                      <h4 className="font-bold text-lg md:text-xl">
                        Dùng thử tương tác 2: Nhập số
                      </h4>
                      <span className="text-slate-400 text-sm font-medium">
                        Điều gì xảy ra khi bạn nhập số?
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="font-mono text-sm md:text-lg text-slate-300 bg-black/30 p-4 md:p-6 rounded-xl border border-white/5 shadow-inner">
                    <div className="text-slate-500 italic mb-2">
                      # Nhập thử một con số bất kì
                    </div>
                    <div className="leading-relaxed">
                      <div>
                        <span className="text-purple-400">du_lieu</span> ={" "}
                        <span className="text-yellow-400">input</span>(
                        <span className="text-green-400">"Nhập số: "</span>)
                      </div>
                      <div>
                        <span className="text-yellow-400">print</span>(
                        <span className="text-green-400">
                          "Bạn vừa nhập chuỗi kí tự: "
                        </span>
                        , <span className="text-purple-400">du_lieu</span>)
                      </div>
                      <div>
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="relative">
                      <div className="absolute left-4 top-1/2 -translate-y-1/2 text-pink-500 font-mono font-bold text-lg">
                        {">"}
                      </div>
                      <input
                        type="text"
                    ...
                    <div className="animate-in fade-in slide-in-from-top-4 duration-500">
                      ...
                      <div className="bg-black p-4 md:p-6 rounded-xl border-l-4 border-pink-500 font-mono text-lg md:text-2xl text-pink-400 shadow-2xl space-y-2">
                        <div className="flex items-center gap-3">
                          <Monitor className="w-6 h-6 md:w-8 md:h-8 opacity-50" />
                          <span>
                            Bạn vừa nhập chuỗi kí tự: "{typeTestOutput.text}"
                          </span>
                        </div>
        ...
        <section id="types" className="space-y-16 md:space-y-32">
          <GlowCard>
            ...
            <div className="mt-8 md:mt-16 pt-8 md:pt-16 border-t-2 md:border-t-4 border-slate-100 space-y-6 md:space-y-12">
              ...
              <h3 className="text-2xl md:text-4xl font-black text-slate-900 mt-8">
                Ép kiểu dữ liệu (Type Casting)
              </h3>
              <p className="text-slate-600 font-bold max-w-2xl">
                Đôi khi ta cần chuyển dữ liệu từ kiểu này sang kiểu khác, ví dụ
                như chuyển xâu người dùng nhập thành số để tính toán.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                ...
                <div className="group relative p-6 bg-purple-50 border-2 border-purple-100 rounded-2xl hover:border-purple-400 transition-all">
                  <div className="absolute -top-3 left-6 px-3 py-1 bg-purple-500 text-white text-xs font-black uppercase rounded shadow-md">
                    Quan trọng
                  </div>
                  <h4 className="font-mono text-2xl font-black text-purple-700 mb-2">
                    int()
                  </h4>
                ...
                <div className="p-6 bg-pink-50 border-2 border-pink-100 rounded-2xl hover:border-pink-400 transition-all">
                  <h4 className="font-mono text-2xl font-black text-pink-700 mb-2">
                    float()
                  </h4>
                  <p className="text-sm font-bold text-slate-700 mb-4">
                  ...
                  <div className="bg-white p-3 rounded-lg border border-pink-100 font-mono text-xs md:text-sm space-y-2 shadow-inner">
                    <div className="flex justify-between">
                      <span>float("3")</span>{" "}
                      <span className="text-pink-600">➜ 3.0</span>
                    </div>
                    <div className="flex justify-between">
                      <span>float(5)</span>{" "}
                      <span className="text-pink-600">➜ 5.0</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 bg-yellow-50 border-2 border-yellow-100 rounded-2xl hover:border-yellow-400 transition-all">
                  <h4 className="font-mono text-2xl font-black text-yellow-700 mb-2">
                    str()
                  </h4>
                  <p className="text-sm font-bold text-slate-700 mb-4">
                    Chuyển thành xâu kí tự.
                  </p>
                  <div className="bg-white p-3 rounded-lg border border-yellow-100 font-mono text-xs md:text-sm space-y-2 shadow-inner">
                    ...
                    <div className="flex justify-between">
                      <span>str(3.5)</span>{" "}
                      <span className="text-yellow-600">➜ "3.5"</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Summary Image */}
        <div className="max-w-5xl mx-auto my-16 group">
          <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/20 bg-white/10 backdrop-blur-md transition-transform duration-500 hover:scale-[1.01]">
            <img
              src="/Tomtat.png"
              alt="Tóm tắt bài học"
          ...
          <div className="p-6 md:p-12 rounded-2xl md:rounded-[3rem] bg-gradient-to-br from-indigo-800 to-purple-900 text-white shadow-2xl relative overflow-hidden">
            <div className="relative z-10 flex flex-col xl:flex-row justify-between items-center gap-6 md:gap-12">
              ...
              <div className="bg-white/10 p-4 md:p-8 rounded-xl md:rounded-[2.5rem] backdrop-blur-3xl border-2 md:border-4 border-white/20 shadow-2xl flex flex-col items-center min-w-[150px] md:min-w-[250px]">
                <div className="text-xs md:text-xl font-black uppercase mb-1 md:mb-4 opacity-60">
                  SCORE
                </div>
                <div className="text-4xl md:text-8xl font-black text-yellow-300 font-mono leading-none">
                  {correctCount}
                </div>
                <div className="text-sm md:text-2xl font-black mt-1 opacity-40">
                  / {quizzes.length}
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:gap-20">
            {quizzes.map((q) => {
              ...
              return (
                <GlowCard
                  key={q.id}
                  className={`!p-4 md:!p-8 !rounded-2xl md:!rounded-[2.5rem]
                   ${
                     isAnswered
                       ? isCorrect
                ...
                >
                  <h3 className="text-lg md:text-2xl font-black text-slate-900 leading-tight mb-4 md:mb-8">
                    {q.question}
                  </h3>
                  ...
                  <div className="grid grid-cols-1 gap-3 md:gap-5">
                    {q.options.map((opt, idx) => {
                      let btnClass =
                        "bg-slate-50 border-2 border-slate-200 text-slate-800 font-black";
                      ...
                      if (isAnswered) {
                        if (idx === q.correct)
                          ...
                          btnClass =
                            "bg-red-500 text-white border-red-600 opacity-50";
                        else
                  ...
                  {isAnswered && (
                    <div
                      className={`mt-4 md:mt-8 p-4 md:p-6 rounded-xl md:rounded-[2rem] border-2 md:border-4
                       ${
                         isCorrect
        ...
        <section id="practice" className="space-y-8 md:space-y-16">
          ...
          <div className="grid grid-cols-1 gap-6 md:gap-10">
            {exercises.map((ex) => (
              <GlowCard
                key={ex.id}
                className="!p-4 md:!p-10 !rounded-2xl md:!rounded-[3rem]"
              >
                <div className="flex items-center gap-3 md:gap-8 mb-3 md:mb-8">
                  ...
                  <h3 className="text-lg md:text-4xl font-black text-slate-900 tracking-tight">
                    {ex.title}
                  </h3>
                </div>
                ...
                <div className="bg-yellow-50 p-4 md:p-8 rounded-xl md:rounded-[2rem] border-l-4 md:border-l-[20px] border-yellow-400 shadow-xl flex items-start gap-3 md:gap-8">
                  ...
                  />
                  <p className="text-xs md:text-xl font-black italic text-slate-900 leading-tight">
                    {ex.hint}
                  </p>
                </div>
              </GlowCard>
